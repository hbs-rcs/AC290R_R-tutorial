...
R is a free, open-source programming language. It can do most things that any
...
![How it should look like at the beginning of this lesson](00_r_starting_how_it_should_like.png)
...
> - results
> - papers
> 1. Files with the .RDA extension are R-Data files. Right-click on [this link](https://raw.githubusercontent.com/hbs-rcs/AC290R_R-tutorial/master/content/data/gapminder-FiveYearData.csv) to "save file as ..."
> 1. Save the `gapminder-FiveYearData.csv` file to the `data/` directory in your project
>
