...
```{r, purl=TRUE}
continents <- factor(c("Europe", "Americas", "Oceana", "Europe", "Africa", "Africa"))
```
...
> continents <- factor(c("Oceana", "Americas", "Asia", "Africa", "Europe", "Europe",
>                    "Asia", "Africa", "Europe"))
> table(continents)
> barplot(table(continents))
> ```
>  
...
> continents <- factor(continents, levels=c("Europe", "Americas", "Asia", "Africa", "Oceana"))
> barplot(table(continents))
> ```
> --->
> 
...
> gapminder <- read.csv('data/gapminder-FiveYearData.csv', stringsAsFactors = FALSE)
> gapminder$continents <- factor(gapminder$continents, 
