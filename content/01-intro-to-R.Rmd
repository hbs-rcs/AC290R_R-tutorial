...
1.  Let's use R to do some unit conversions. Suppose you're thinking about running a 5 kilometer race and you want to know how many miles that is. Let's create a variable `distance_km` and assign it the value `5`.
...
3.  Given these two variables, create a third variable `distance_miles` that contains the number of miles in the race.
